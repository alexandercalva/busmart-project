...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'date-time',
                loadChildren: () => __webpack_require__.e(/*! import() | date-time-date-time-module */ "date-time-date-time-module").then(__webpack_require__.bind(null, /*! ../date-time/date-time.module */ "./src/app/pages/date-time/date-time.module.ts")).then(m => m.DateTimePageModule)
            },
            {
                path: '',
